    ...
    FlutterWebViewClient(MethodChannel methodChannel) {
        ...
        myHandler = new Handler() {
            ...
            public void handleMessage(@NonNull Message msg) {
                msghandle(msg.obj.toString());
                super.handleMessage(msg);
            }
        };
    }

    private void msghandle(String url) {
//                System.out.println(url);
        Map<String, Object> args = new HashMap<>();
        args.put("url", url);
        methodChannel.invokeMethod("onRequest", args);
    }
    ...
    private void onRequest(WebView view, String url) {
    ...
    private WebViewClient internalCreateWebViewClient() {
        return new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                FlutterWebViewClient.this.onRequest(view, request.getUrl().toString());
